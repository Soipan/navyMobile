...
function mapStateToProps(state) {
  ...
  const {receipt} = state.subscription;
...
const actionCreators = (dispatch, props) => {
  return {
    setIsSubscribed: boolean => {
      dispatch(subscriptionActions.setsubscriptionstatus(boolean));
    },
    setSubscription: subscription => {
      dispatch(subscriptionActions.setsubscription(subscription));
    },
    setRestoredPuchases: purchases => {
      dispatch(subscriptionActions.setrestoredpurchases(purchases));
    },
  };
};
